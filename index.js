...
//function getFirstArtist(array){
  //let firstArtist = array[0].name;
  //return firstArtist 
//}

//console.log(getFirstArtist(artists));
...
function getArtistByIndex(id, array) {
  let nameId = array[id].id;
  let artistName = array[id].name;
  return `The artist at index ` + nameId + ' is ' + artistName;
  }
...
console.log(checkArtist('Eric Emily', artists))
